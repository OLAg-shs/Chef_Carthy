...
#clock, #network, #pulseaudio, #battery, #custom-notification, #custom-power {
  padding: 0 8px;
}
#custom-power {
  color: #A6534A;
...
```jsonc
{
  ...
  "custom/launcher": { "format": "", "on-click": "rofi -show drun -theme ~/.config/rofi/chefos.rasi", "tooltip": false },
  "custom/search":   { "format": "", "on-click": "rofi -show run -theme ~/.config/rofi/chefos.rasi", "tooltip": false },
  "custom/files":    { "format": "", "on-click": "nautilus", "tooltip": false },
  "custom/terminal": { "format": "", "on-click": "alacritty", "tooltip": false },
  "custom/spotify":  { "format": "", "on-click": "spotify", "tooltip": false },
  "custom/volume":   { "format": "", "on-click": "pavucontrol", "tooltip": false },
  "custom/network":  { "format": "", "on-click": "nm-connection-editor", "tooltip": false },
  "custom/notifications": { "format": "", "on-click": "swaync-client -t", "tooltip": false },
  "custom/settings": { "format": "", "on-click": "nwg-look", "tooltip": false },
  "custom/power":    { "format": "⏻", "on-click": "wlogout", "tooltip": false }
}
```
(Icons above use Font Awesome glyphs via `ttf-font-awesome`; if a glyph
doesn't render, swap to any Nerd Font — do not leave blank boxes.)
...
5. Section 6 sidebar dock visible, all icons clickable.
6. Section 5 top bar visible, workspaces/clock/tray working.
...
- [ ] Top bar + left sidebar both visible, correct colors/fonts
